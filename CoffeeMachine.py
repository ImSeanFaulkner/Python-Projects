...
def is_resource_sufficient(order_ingredients):
    """Returns True when ordercan be made and false if ingredients insufficient"""
...
def process_coins():
    ...
    total = int(input("How many 5 cent coins ")) * 0.05
...
def is_transaction_successful(money_recieved, drink_cost):
    """Returns True when payment successful and False if money is insufficient"""
